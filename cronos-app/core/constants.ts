...
export const SUPABASE_URL = process.env.EXPO_PUBLIC_SUPABASE_URL || 'https://lqmnkkaynvilknahmpqq.supabase.co';
export const SUPABASE_ANON_KEY = process.env.EXPO_PUBLIC_SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxxbW5ra2F5bnZpbGtuYWhtcHFxIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Njk1MDcyNTYsImV4cCI6MjA4NTA4MzI1Nn0.aicI4RbxxstYZNBHNtIOcCZ8SeEYuFd3RTzmX5QTXho';
...
// RevenueCat API Keys
export const REVENUECAT_API_KEY_IOS = process.env.EXPO_PUBLIC_REVENUECAT_API_KEY_IOS || 'test_jPfReQpJdNOcAfKqjAIODdaemSM';
export const REVENUECAT_API_KEY_ANDROID = process.env.EXPO_PUBLIC_REVENUECAT_API_KEY_ANDROID || 'test_jPfReQpJdNOcAfKqjAIODdaemSM';
